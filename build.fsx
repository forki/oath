...
let summary = "Unit test XSLT with F#."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Unit test XSLT with F#."

// List of author names (for NuGet package)
let authors = [ "Eero Helenius" ]

// Tags for your project (for NuGet package)
let tags = "XSLT Test F#"

// File system information
let solutionFile  = "Oath.sln"

// Default target configuration
let configuration = "Release"

// Pattern specifying assemblies to be tested using Expecto
let testExecutables = "./tests/Oath.Tests/**/bin/Release/*.exe"

// Git configuration (used for publishing documentation in gh-pages branch)
// The profile where the project is posted
let gitOwner = "eerohele"
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/eerohele"
...
Target "GenerateHelp" (fun _ ->
    ...
    Rename "docs/content/release-notes.md" "docs/content/CHANGELOG.md"
