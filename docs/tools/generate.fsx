...
let githubLink = "https://github.com/eerohele/Oath"

// Specify more information about your project
let info =
  [ "project-name", "Oath"
    "project-author", "Eero Helenius"
    "project-summary", "Unit test XSLT with F#."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Oath" ]
